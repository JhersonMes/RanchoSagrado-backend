...
public class PaymentController {
    ...
    public EntityModel<PaymentDTO> findByIdHateoas(@PathVariable("id") Integer id) throws Exception {
        Payment obj = service.findById(id);
    ...
    @GetMapping("/pageable")
    public ResponseEntity<Page<Payment>> listPageable(Pageable pageable){
        Page<Payment> page = service.listPage(pageable);
